...
// let clicks = {}; //change for return a value fron inner function Ch1.3

function updateClicks() {
  // let button = menu.id; //change for return a value fron inner function Ch1.3
  let clicks = {};
  // let button; //remove for Ch1.4
  // clicks[button] = clicks[button] + 1 || 1; //change for return a value fron inner function Ch1.3
  function reportClicks(item) {
    //remove menu and change all to item for Ch1.4
    // button = menu.id; //remove for Ch1.4
    clicks[item] = clicks[item] + 1 || 1;
    //change for return a value fron inner function Ch1.3
...
const listWidget = (function () {
  ...
  return {
    ...
    apiKey: "ce942566ad361692088b80001c71f772", // Replace "APIKEY" with your own API key; otherwise, your HTTP request will not work
...
document.querySelectorAll('.options div').forEach(function (el) {
  el.addEventListener('click', function (event) {
    ...
    // updateClicks(event.target); //change for return a value fron inner function Ch1.3
    reportActivities(event.target.id);
  }, false);
});

// update list of products when mouseenter Ch1.4
